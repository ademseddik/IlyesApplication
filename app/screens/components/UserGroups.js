...
// import GroupMembersModal from "../../PopUps/GroupMembersModal";
// import InviteToGroupModal from "../../PopUps/InviteToGroupModal";
// import CommentModel from "../../PopUps/CommentModel";
// import SendModel from "../../PopUps/SendModel";
// import ShareModel from "../../PopUps/ShareModel";
// import PostOptionsModel from "../../PopUps/PostOptionsModel";


// const UserGroups = ({ route }) => {
...
//         `tawasalna-community/group/getprofilephoto/${groupData.id}`,
//         {
...
//     try {
//       const response = await createAxiosInstance().get(
//         `tawasalna-community/group/posts/${groupData.id}`
//       );
...
//     try {
//       const response = await createAxiosInstance().get(
//         `tawasalna-community/group/getGroupById/${groupData.id}`
//       );
...
//         `tawasalna-community/group/updateGroupPicture/${groupData.id}`,
//         formData,
//         {
//           headers: {
...
//         `tawasalna-community/group/addpost/${groupData.id}/${userId}`,
//         formData,
//         {
//           headers: {
//             "Content-Type": "multipart/form-data",
...
//         `tawasalna-community/group/join/${groupData.id}/${userIdStorage}`
//       );
...
//         `tawasalna-community/group/leave/${groupData.id}/${userIdStorage}`
//       );
...
//       const userId = await AsyncStorage.getItem("userId");
//       const response = await createAxiosInstance().post(
//         `tawasalna-community/residentprofile/likepost/${postId}/${userId}`
//       );
...
//       const userId = await AsyncStorage.getItem("userId");
//       const response = await createAxiosInstance().delete(
//         `tawasalna-community/residentprofile/dislikepost/${postId}/${userId}`
//       );
//       return response.data;
//     } catch (error) {
...
//                       {post.user.residentProfile.fullName ||
