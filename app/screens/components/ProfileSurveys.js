...
//         `tawasalna-community/survey/creator/${userId}`
//       );
//       if (response.data) {
...
//       const userId = await AsyncStorage.getItem("userId");
//       const response = await createAxiosInstance().get(
//         `tawasalna-community/survey/UserResponse/${surveyId}/${userId}/${questionIndex}`
//       );
//       if (response.data) {
...
//     try {
//       const response = await createAxiosInstance().get(
//         `tawasalna-community/survey/questionTextResponses/${surveyId}/${questionIndex}`
//       );
//       if (response.data) {
...
//     try {
//       const response = await createAxiosInstance().get(
//         `tawasalna-community/survey/choiceCounts/${surveyId}`
//       );
//       return response.data;
//     } catch (error) {
...
//         `tawasalna-community/survey/respondToSurvey/${surveyId}/${userId}`,
//         {
//           questionIndex,
